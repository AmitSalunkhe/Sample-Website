...
export default function PlayerBar() {
  ...
  return (
    <>
      {/* The bar is fixed, so it would otherwise sit on top of the last row of
          a list. This spacer sits in flow at the end of the page and gives it
          somewhere to be. */}
      ...
      >
        <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3 sm:gap-4 sm:px-8">
          ...
          >
            {playing ? (
              <Icon d="M7 5h4v14H7zM13 5h4v14h-4z" />
            ) : (
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1.5 flex items-center gap-2">
              ...
              <input
                ...
                className="scrubber w-full cursor-pointer rounded-full outline-offset-4"
                style={{
