...
export const PIECES: Piece[] = [
  ...
  },
  {
    ...
    name: "Mayura",
    collection: "Bridal",
    src: "/jewels/necklace-2.webp",
    metal: "22k yellow gold",
    stones: "Uncut kundan, emerald, natural pearl",
    price: "₹8,40,000",
    note:
      "Two peacocks face each other across the centre plaque, worked in repoussé and finished with red and green meenakari. Three strands of hand-strung gold beads, and every kundan stone set in pure gold foil the old way, without a single claw.",
    scale: 1.08,
  },
  {
    id: "lumiere",
